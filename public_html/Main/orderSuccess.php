...
$first_name = 'Afandi';//$_POST['firstname'];
$last_name =  'Indiatsi';//$_POST['lastname'];
$email = 'gindiazi@gmail.com';//$_POST['email'];
...
<div class="container">
    ...
    <p>Your booking has submitted successfully. Booking ID is #<?php echo $_GET['id']; ?></p>
</div>

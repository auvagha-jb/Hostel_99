                ...
                <?php
                    ...
                    while($row = $result->fetch_array()){
                        echo '<li><strong>'.$row['no_sharing'].' Sharing </strong> Kshs. '.$row['monthly_rent'].' per month
                                <a href="cartAction.php?action=addToCart&id='.$row['no_sharing'].'" style="margin-left:350px;margin-bottom:5px;" class="btn btn-success">
                                    <i class="fas fa-bookmark"></i>Book this hostel
                                </a>
                            </li>';
                    }
                ?>
